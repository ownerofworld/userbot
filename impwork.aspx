...
&nbsp;Please use ‘between the column names,’Separate, don’t write it means all</td>
</tr>
<tr>
<td>
Number of grouping rows：</td>
<td>
<asp:TextBox ID="txtNum" runat="server" Width="172px"></asp:TextBox>
&nbsp; 
It can be used when there is a lot of data</td>
</tr>
<tr>
<td>
保存文件名：</td>
...
<tr>
<td colspan="2″ align="center">
<asp:Button ID="Button1″ runat="server" Text="Start export" onclick="Button1_Click" />
</td>
